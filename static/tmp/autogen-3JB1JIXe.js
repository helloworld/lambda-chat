...
var commands = {
  ...
  "gif": function(text) {
    $.get(`https://api.giphy.com/v1/gifs/search?api_key=yHfmOTJKcqqJxEGDTnNG1kJRBFngRm0V&q=${text}&limit=1&offset=0&rating=G&lang=en`, function(data) {
      console.log(data)
      return `<img src="${data.data[0].images.fixed_width.url}" width="560", height="315">`
    })
  }
}
